...
const deleteMemory = (): void => {
    if (
        confirm(
            `Are you sure you want to delete "${props.memory.title}"? This action cannot be undone.`,
        )
    ) {
            ...
            <Card class="max-w-3xl">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <Button
                                ...
                                variant="outline"
                                size="sm"
                                class="gap-2 text-red-600 hover:border-red-300 hover:text-red-700 dark:hover:border-red-700 dark:hover:text-red-500"
                            >
                ...
                <CardContent class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div
                            class="prose prose-slate dark:prose-invert max-w-none rounded-lg border p-4"
                        >
